...
import { GetContainerRepositoryImageDetailsResponse, ListContainerRepositoryTagsResponse } from "~/bindings";
...
const ContainerImages = (props: ContainerImagesProps) => {
                                    ...
                                    <tr class="border-b border-gray-700/50 hover:bg-secondary-dark/50">
                                        ...
                                        <td class="py-3 px-4">
                                            <div class="flex flex-wrap gap-2">
                                                <For each={image.tags}>
                                                    {(tag) => (
                                                        <span class="text-primary bg-primary/10 px-2 py-1 rounded text-sm font-mono">
                                                            {tag}
                                                        </span>
                                                    )}
                                                </For>
