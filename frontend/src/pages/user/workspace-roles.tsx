			...
			<Suspense fallback={<div class="text-gray-400 text-sm">Loading permissions...</div>}>
				<div class={`flex gap-3 items-center ${get(props.class)}`}>
						...
						<div class="flex flex-[2.5] flex-col gap-3">
							<InputDropdown
								...
								options={[
									...
									{
										label: selectedResourceType()
											? `Include Specific ${parseCamelCase(selectedResourceType())}(s)`
											: "Include Specific Resources",
										value: "include",
									},
									{
										label: selectedResourceType()
											? `Exclude Specific ${parseCamelCase(selectedResourceType())}(s)`
					...
					<div class="flex items-end justify-center">
						<Button onClick={onClickAdd} type="button" variant={ButtonVariant.Contained}>
							<FiPlus />
						</Button>
					</div>
				</div>
