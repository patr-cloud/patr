		...
		<>
			...
			<main class="min-h-screen w-full bg-secondary flex items-center justify-center p-4 relative overflow-hidden">
				...
				<section class="bg-[#1a0f2e]/70 backdrop-blur-md p-12 rounded-3xl shadow-2xl w-full max-w-125 relative z-10 border border-[#2a1f3d] text-center">
					{/* 404 Number */}
					<div class="mb-6">
						<h1 class="text-[120px] font-bold text-transparent bg-clip-text bg-linear-to-r from-primary via-orange-400 to-primary leading-none">
							404
						</h1>
					</div>
					...
					<div class="mb-8">
						...
						<p class="text-grey text-base leading-relaxed">
