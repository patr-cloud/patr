...
pub mod id {
	...
	pub const DOMAIN_TRANSFERRED: &str = "DomainTransferred";
}
...
pub mod message {
	...
	pub const DOMAIN_TRANSFERRED: &str = "It seems like transfer domain to patr is successfull. Cannot cancel now";
}
