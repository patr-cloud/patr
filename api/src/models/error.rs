...
pub mod id {
	...
	pub const MISSING_PERMISSION: &str = "missingPermission";
...
pub mod message {
	...
	pub const MISSING_PERMISSION: &str = "You do not have the desired permission to create the resource. Make sure you have all the dependent permission to create the resource";
