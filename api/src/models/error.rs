...
pub mod id {
	...
	pub const PASSWORD_MATCH_OLD: &str = "passwordMatchOld";
...
pub mod message {
	...
	pub const PASSWORD_MATCH_OLD: &str = "Your new password matches your old password. Please choose a different password";
