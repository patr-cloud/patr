...
pub mod id {
	...
	pub const PASSWORD_IS_SIMILAR: &str = "passwordIsSimilar";
...
pub mod message {
	...
	pub const PASSWORD_IS_SIMILAR: &str = "Your new password matches your old password. Please choose a different password";
