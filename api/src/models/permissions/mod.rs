...
use models::{RequestUserData, rbac::WorkspacePermission, utils::ActorClientType};
use rustis::{
...
/// [`web_dashboard`].
///
/// The resolved [`ActorClientType`] is available on the returned
/// [`RequestUserData`].
