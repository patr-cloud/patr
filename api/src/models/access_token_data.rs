...
pub struct AccessTokenData {
	...
	/// this JWT. This would usually only be the Patr API, I'm guessing, but can
	/// be other clients as well if some other application tries to access Patr
	/// API using a OAuth client.
