...
pub const DEFAULT_MACHINE_TYPES: [(i16, i32, &str); 5] = [
	(1, 2, "deployment-nano"),   // 1 vCPU, 0.5 GB RAM
	(1, 4, "deployment-micro"),  // 1 vCPU, 1 GB RAM
	(1, 8, "deployment-small"),  // 1 vCPU, 2 GB RAM
	(2, 8, "deployment-medium"), // 2 vCPU, 4 GB RAM
	(4, 32, "deployment-large"), // 4 vCPU, 8 GB RAM
];
