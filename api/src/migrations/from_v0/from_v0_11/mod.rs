...
///   version is not 0.11.x, more info here: [`Version`]: Version
///
/// # Return
...
pub async fn migrate(
	...
	match (version.major, version.minor, version.patch) {
		(0, 11, 0) => from_v0_11_0::migrate(&mut *connection, config).await,
		_ => {
...
/// # Description
/// The function is used to get a list of all 0.11.x migrations to migrate the
/// database from
///
/// # Return
