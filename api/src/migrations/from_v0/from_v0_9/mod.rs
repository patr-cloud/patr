...
///   version is not 0.9.x, more info here: [`Version`]: Version
///
/// # Return
...
pub async fn migrate(
	...
	match (version.major, version.minor, version.patch) {
		(0, 9, 0) => from_v0_9_0::migrate(&mut *connection, config).await,
		(0, 9, 1) => from_v0_9_1::migrate(&mut *connection, config).await,
		_ => {
...
/// # Description
/// The function is used to get a list of all 0.9.x migrations to migrate the
/// database from
///
/// # Return
