...
///   version is not 0.16.x, more info here: [`Version`]: Version
///
/// # Return
...
pub async fn migrate(
	...
	match (version.major, version.minor, version.patch) {
		(0, 16, 0) => from_v0_16_0::migrate(&mut *connection, config).await,
		(0, 16, 1) => from_v0_16_1::migrate(&mut *connection, config).await,
		_ => {
...
/// # Description
/// The function is used to get a list of all 0.16.x migrations to migrate the
/// database from
///
/// # Return
