...
///   version is not 0.12.x, more info here: [`Version`]: Version
///
/// # Return
...
pub async fn migrate(
	...
	match (version.major, version.minor, version.patch) {
		(0, 12, 0) => from_v0_12_0::migrate(&mut *connection, config).await,
		(0, 12, 1) => from_v0_12_1::migrate(&mut *connection, config).await,
		_ => {
...
/// # Description
/// The function is used to get a list of all 0.12.x migrations to migrate the
/// database from
///
/// # Return
