...
///   version is not 0.10.x, more info here: [`Version`]: Version
///
/// # Return
...
pub async fn migrate(
	...
	match (version.major, version.minor, version.patch) {
		(0, 10, 0) => from_v0_10_0::migrate(&mut *connection, config).await,
		(0, 10, 1) => from_v0_10_1::migrate(&mut *connection, config).await,
		_ => {
...
/// # Description
/// The function is used to get a list of all 0.10.x migrations to migrate the
/// database from
///
/// # Return
