...
//!
//! The column carries no default of its own. `DEFAULT FALSE` here exists only
//! to fill the rows that already exist, and is dropped again immediately, so
//! every inserter has to say which kind of role it is creating.
