...
where
	S: for<'a> Service<AppRequest<'a, E>>,
	E: ApiEndpoint,
{
...
where
	...
	E: ApiEndpoint,
	S: for<'a> Service<AppRequest<'a, E>, Response = AppResponse<E>, Error = ErrorType> + Clone,
{
	...
	fn poll_ready(&mut self, cx: &mut Context<'_>) -> Poll<Result<(), Self::Error>> {
		self.inner
			.poll_ready(cx)
			.map_err(|_| unreachable!("Layers must always be ready to poll"))
	}
