...
lazy_static! {
	// Can only contain a-z, A-Z, 0-9, . and -. Cannot begin with a . (github rules, basically)
	static ref USERNAME_REGEX: Regex = Regex::new("^[a-zA-Z0-9]+((-[a-zA-Z0-9]+)|(\\.[a-zA-Z0-9]+))*$").unwrap();
