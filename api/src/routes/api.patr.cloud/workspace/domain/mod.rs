...
pub async fn setup_routes(state: &AppState, allowed_client_types: &[ClientType]) -> Router {
	Router::new()
		...
		.mount_auth_endpoint(add_dns_record, state, allowed_client_types)
		.mount_auth_endpoint(delete_dns_record, state, allowed_client_types)
		.mount_auth_endpoint(get_doamin_dns_record, state, allowed_client_types)
		.mount_auth_endpoint(get_domain_info_in_workspace, state, allowed_client_types)
		.mount_auth_endpoint(update_domain_dns_record, state, allowed_client_types)
