...
pub async fn setup_routes(state: &AppState, host_client_types: &[ActorClientType]) -> Router {
	Router::new()
		...
		.mount_auth_endpoint(get_runner_metrics, state, host_client_types)
		.mount_auth_endpoint(stream_runner_logs, state, host_client_types)
		.mount_auth_endpoint(create_runner_link, state, host_client_types)
		.mount_auth_endpoint(verify_runner_link, state, host_client_types)
		.mount_auth_endpoint(get_runner_link, state, host_client_types)
		.mount_auth_endpoint(approve_runner_link, state, host_client_types)
		.mount_auth_endpoint(reconnect_runner_link, state, host_client_types)
}
