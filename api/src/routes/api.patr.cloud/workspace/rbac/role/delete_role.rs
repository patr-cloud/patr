...
pub async fn delete_role(
	...
	// Token ceilings and user bindings both FK the role; membership rows are
	// untouched — deleting a role no longer evicts anyone from the workspace.
	let grants_removed = db::delete_bindings_for_role(&mut **database, &role_id).await?;
