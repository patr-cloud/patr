...
pub async fn setup_routes(state: &AppState, host_client_types: &[ActorClientType]) -> Router {
	Router::new()
		.mount_auth_endpoint(invite_user_to_workspace, state, host_client_types)
		.mount_auth_endpoint(list_users_in_workspace, state, host_client_types)
		.mount_auth_endpoint(list_workspace_invites, state, host_client_types)
		.mount_auth_endpoint(remove_user_from_workspace, state, host_client_types)
		.mount_auth_endpoint(resend_workspace_invite, state, host_client_types)
		.mount_auth_endpoint(revoke_workspace_invite, state, host_client_types)
		.mount_auth_endpoint(update_user_roles_in_workspace, state, host_client_types)
		.mount_auth_endpoint(update_workspace_invite_roles, state, host_client_types)
}
