...
/// * `organisation_id` -  an unsigned 8 bit integer array containing the id of organisation
///	* `name` - a string containing the name of deployment
///	* `registry` - a string containing the url of docker registry
/// * `repository_id` - An Option<&str> containing either a repository id of type string or `None`
///	* `image_name` - An Option<&str> containing either an image name of type string or `None`
/// * `image_tag` - a string containing tags of docker image
///
/// # Returns
/// This function returns Result<Uuid, Error> containing an uuid of the deployment or an
/// error
///
...
/// # Arguments
/// * `connection` - database save point, more details here: [`Transaction`]
/// * `deployment_id` -  an unsigned 8 bit integer array containing the id of deployment
///	* `exposed_ports` - an unsigned 16 bit integer array containing the exposed ports of deployment
...
/// * `organisation_id` -  an unsigned 8 bit integer array containing the id of organisation
///	* `name` - a string containing the name of deployment
///	* `machine_types` - an array of type [`MachineType`] containing the details about machine type
...
/// # Arguments
/// * `connection` - database save point, more details here: [`Transaction`]
/// * `upgrade_path_id` -  an unsigned 8 bit integer array containing the id of the upgrade path
...
/// * `deployment_id` - an Option<&str> containing an unsigned 8 bit integer array containing 
/// the id of deployment or `None`
/// * `deployment_port` - an Option<u16> containing an unsigned 16 bit integer containing port 
/// of deployment or an `None`
/// * `url` - an Option<&str> containing a string of the url for the image to be deployed
///
/// # Returns
/// This function returns `Result<uuid, Error>` containing uuid of the entry point or an error
///
/// [`Transaction`]: Transaction
/// [`MachineType`]: MachineType
