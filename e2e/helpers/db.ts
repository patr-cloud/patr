...
export async function backdateSignupOtp(
  username: string,
  age: string,
): Promise<void> {
  await pool.query(
...
export async function backdatePasswordResetToken(
  username: string,
  age: string,
): Promise<void> {
  await pool.query(
...
export async function exhaustPasswordResetAttempts(
  username: string,
  count: number,
): Promise<void> {
  await pool.query(
...
export async function backdateWebLoginExpiry(
  loginId: string,
  age: string,
): Promise<void> {
  await pool.query(
